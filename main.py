...
async def start_command(message: types.Message):
    ...
    await message.answer('Это бот PlantPal - ваш помошник в уходе за растениями 🌱\n🔹PlantPal отправит данные о среде, окружающей растение. \n🔹Или построит графики по данным. \n🔹А ещё уведомит о критических значениях на датчиках, чтобы точно вы точно не забыли полить растение или включить подсветку для рассады. ', reply_markup= m.mainMenu)
